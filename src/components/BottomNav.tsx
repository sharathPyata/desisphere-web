  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-[--color-border-light]">
      <div className="max-w-6xl mx-auto flex items-center justify-around h-16">
        ...
        >
          <svg className="w-6 h-6 text-[--color-text-tertiary]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
          </svg>
          <span className="text-[10px] font-semibold text-[--color-text-tertiary]">Favourites</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] font-semibold text-[--color-text-tertiary]">Profile</span>
        </button>
      </div>
    </nav>
  );

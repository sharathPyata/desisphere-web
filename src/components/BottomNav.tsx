    ...
    <nav className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-[--color-border-light]">
      <div className="max-w-2xl mx-auto flex items-center justify-around h-16">
        ...
        >
          ...
          <span className="text-[10px] font-medium text-[--color-text-tertiary]">Favourites</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] font-medium text-[--color-text-tertiary]">Profile</span>
        </button>
      </div>
    </nav>
  );
